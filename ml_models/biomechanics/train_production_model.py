...
def main():
    ...
    # Paths
    data_dir = Path("datasets/biomechanics")
    ...
    if not metadata_path.exists():
        ...
        import subprocess
        subprocess.run(["python", "datasets/generate_biomechanics_dataset.py"])
    ...
    for epoch in range(num_epochs):
        ...
        if val_metrics['form_rmse'] < best_val_loss:
            ...
            }, 'ml_models/biomechanics/gnn_lstm_best.pth')
            print(f"  ✅ Saved best model (Form RMSE: {best_val_loss:.2f})")
    
    print("\n🎉 Training complete!")
    print(f"📁 Model saved to: ml_models/biomechanics/gnn_lstm_best.pth")
