...
╚════════════════════════════════════════════════════════════════════╝
    ...
    if results['biomechanics_data']:
        results['biomechanics_model'] = run_command(
            [sys.executable, "ml/biomechanics/train_production_model.py"],
    ...
    if results['burnout_data']:
        results['burnout_model'] = run_command(
            [sys.executable, "ml/burnout/train_production_model.py"],
    ...
    if successful == total:
        ...
        print("\n📁 Model Locations:")
        print("  - Biomechanics: ml/biomechanics/gnn_lstm_best.pth")
        print("  - Burnout Cox: ml/burnout/cox_ph_model.pkl")
        print("  - Burnout RF: ml/burnout/random_forest_model.pkl")
        print("  - Burnout GB: ml/burnout/gradient_boosting_model.pkl")
        print("\n📊 Dataset Locations:")
        print("  - Biomechanics: data/biomechanics/")
        print("  - Burnout: data/burnout/")
