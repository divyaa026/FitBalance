...
def train_cnn_food_classifier():
    ...
    try:
        from ml.nutrition.cnn_food_classifier import FoodClassifierCNN, FoodClassifierTrainer
...
def train_gru_protein_optimizer():
    ...
    try:
        from ml.nutrition.gru_protein_optimizer import ProteinOptimizer, HealthMetrics
...
def test_trained_models():
    ...
    try:
        from ml.nutrition.cnn_food_classifier import FoodClassifierInference
        from ml.nutrition.gru_protein_optimizer import ProteinOptimizer, HealthMetrics
        from ml.nutrition.shap_explainer import initialize_shap_explainer
...
def create_demo_dataset():
    ...
    try:
        ...
        os.makedirs("data/food_images", exist_ok=True)
        ...
        df_health.to_csv("data/health_metrics_dataset.csv", index=False)
