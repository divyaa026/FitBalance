...
def create_mock_models():
    ...
    results['biomechanics'] = run_command(
        "python ml\\biomechanics\\create_mock_models.py",
        "Biomechanics models"
    )
    ...
    results['burnout'] = run_command(
        "python ml\\burnout\\create_mock_models.py",
        "Burnout models"
    )
...
def test_all_systems():
    ...
    try:
        ...
        try:
            from ml.nutrition.cnn_food_classifier import CNNFoodClassifier
        ...
        try:
            from ml.biomechanics.gnn_lstm import BiomechanicsModel
        ...
        try:
            from ml.burnout.cox_model import BurnoutCoxModel
