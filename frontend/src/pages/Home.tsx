            ...
            <div className="text-left animate-fade-in space-y-6 flex flex-col justify-center">
              ...
              <div className="flex flex-wrap items-center gap-4 pt-2">
                <Link to="/biomechanics">
                  <Button className="gradient-hero text-white hover:opacity-90 transition-all duration-300 px-8 py-4 text-lg font-semibold rounded-full shadow-2xl hover:shadow-purple-500/25">
                    Start Your Journey
                    <ArrowRight className="ml-2 h-6 w-6" />
                  </Button>
                </Link>
                <Link to="/profile">
                  <Button className="border-2 border-purple-400 text-purple-200 hover:bg-purple-400 hover:text-white px-8 py-4 text-lg font-semibold rounded-full transition-all duration-300">
                    View Profile
                  </Button>
                </Link>
              </div>
      ...
      <section className="px-4 py-24 relative z-10">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16 animate-slide-up">
            ...
            <p className="text-purple-200 text-lg max-w-2xl mx-auto leading-relaxed">
              Stay informed with expert advice and the latest trends in fitness and nutrition
            </p>
          </div>
          ...
          <div className="grid gap-8 animate-slide-up">
            {[
              ...
              {
                id: "2",
                title: "Optimizing Post-Workout Nutrition",
